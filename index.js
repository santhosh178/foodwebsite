...
// const address = fetch("http://localhost:8080/food/food/item-list",{
//         method: 'GET',
//         headers: {
...
// var foodItem =fetch('http://localhost:8080/food/food/item-list', {
//     mode:'no-cors',
//     method: 'GET',
//     headers: {
//         'Accept': 'application/json',
...
// Request ='no-cors';
// let url=("http://localhost:8080/food/food/item-list",{ mode: 'no-cors'});
// console.log(fetch(url));

// var foodItem =fetch('http://localhost:8080/food/food/item-list',{ mode: 'no-cors'}).then((res)=>res.json())
// .then((data)=> {console.log(data) 
// return data}).catch((err)=>console.log(err));
// var foodItem =fetch(url).then((response) => {
//     return response.json().then(data);
//   });

// const fetchedData = fetch('http://localhost:8080/food/food/item-list',{
...
function displayItems() {
    ...
    console.log(foodItem.filter(item=> item.category=='biryani'));
...
function categoryLists() {
    ...
    categoryListData.map(item=> {
        ...
        document.getElementById('category-header').appendChild(cloneListCard);
    })
}
categoryLists();
...
function cartItems() {
    ...
    cartData.map(item=> {
        ...
        btn1.setAttribute('class','decrease-btn');
        btn1.innerText = '-';
        var span = document.createElement('span');
        span.innerText = item.quantity;
        var btn2 = document.createElement('button');
        btn2.setAttribute('class','increase-btn');
        btn2.innerText = '+';
